// Basic way without minus button interactive
...
document.getElementById("phone-minus").addEventListener("click", function (){
    ...
    // get and update price
    const phonePrice = document.getElementById('phone-price');
    let phonePriceText = parseInt(phonePrice.innerText);
    if (phonePriceText > 0){
      phonePrice.innerText = phonePriceText - 1219;
    }
    // checkOut(updateAmount);
    // update the amount value and store it (decrease)
...
document.getElementById("case-minus").addEventListener("click", function (){
    ...
    // get and update price
    const casePrice = document.getElementById('case-price');
    let casePriceText = parseInt(casePrice.innerText);
    if (casePriceText > 0){
      casePrice.innerText = casePriceText - 59;
    }
})
...
// Advance way with full functionality
